...
class SmileyView : CustomViewScaffold {
	...
	private val scaleGestureDetector: ScaleGestureDetector = ScaleGestureDetector(context,
		object : SimpleOnScaleGestureListener() {
			override fun onScaleBegin(detector: ScaleGestureDetector): Boolean = isConsumeNextGesture
...
private class SmileySavedState: BaseSavedState {
	...
	companion object CREATOR : Parcelable.Creator<SmileySavedState> {
		override fun createFromParcel(parcel: Parcel): SmileySavedState {
			return SmileySavedState(parcel)
		}

		override fun newArray(size: Int): Array<SmileySavedState?> {
